...
(function () {
  ...
  const JA = {
    ...
    's08.eyebrow': 'オペレーションフロー',
    's08.h2': '月次の baseline 運用プロセス',
    's08.c1.h3': '月次サイクル',
    's08.c1.t0': '収集と標準化',
    's08.c1.d0': 'C · R · CxRy · Effort · Bug · Rework',
    's08.c1.t1': 'baseline マッピング',
    's08.c1.d1': 'P25–P90 · 同一 CxRy',
    's08.c1.t2': '比較・分類',
    's08.c1.d2': 'baseline 閾値との比較',
    's08.c1.t3': '標準からの乖離と RCA',
    's08.c1.note4':
      '<strong>&gt; P90</strong> → RCA 必須<br><strong>&lt;P25</strong> → effort log / 品質 / グルーピングをレビュー',
    's08.c1.t4': 'アクション',
    's08.c1.d4': 'Root cause → 改善',
    's08.c1.t5': 'ローリング baseline',
    's08.c1.d5': '直近4か月で baseline を更新し、トレンドを追跡',
    's08.c2.h3': 'レビューアウトプット',
    's08.c2.i0t': '4状態別チケット一覧',
    's08.c2.st0': 'Low',
    's08.c2.st1': 'Normal',
    's08.c2.st2': 'Warning',
    's08.c2.st3': 'Abnormal',
    's08.c2.i1t': 'RCA / 深掘りレビュー',
    's08.c2.i1d': '> P90 を中心に、必要に応じて <P25 もレビュー',
    's08.c2.i2t': '原因カテゴリ別の RCA 集約',
    's08.c2.c0': 'CxRy',
    's08.c2.c1': 'Spec',
    's08.c2.c2': 'Dev',
    's08.c2.c3': 'System',
    's08.c2.c4': 'Dependency',
    's08.c2.c5': 'Data',
    's08.c2.i3t': '新しい月の baseline とトレンド',
    's08.c2.m0': 'Median',
    's08.c2.m1': 'P75',
    's08.c2.m2': 'P90',
    's08.c2.m3': 'Stability',
    's08.c2.m4': 'Outlier',
    's08.pill':
      '標準化 → CxRy マップ → 比較 → RCA/アクション → ローリング → トレンド',

    's09.eyebrow': 'RCA',
    's09.h2': 'ベースラインは異常検知の道具であり RCA につながる',
    's09.c1.h3': 'いつ RCA / より深いレビューが必要か',
    's09.c1.li0': 'チケット > P90: 工数が異常',
    's09.c1.li1': 'チケット < P25: 異常に速い、品質または工数記録の確認',
    's09.c1.li2': 'グループの Outlier rate の上昇: プロセス不安定の兆候',
    's09.c2.h3': '原因カテゴリ',
    's09.c2.li0': 'CxRy: 業務グループの誤分類',
    's09.c2.li1': 'Spec: 要件が不明確または変更',
    's09.c2.li2': 'Dev: 実行上の問題',
    's09.c2.li3': 'System: 技術的負債 / システム制約',
    's09.c2.li4': 'Data: 工数記録の不正確さ',
    's09.pill':
    ...
    's10.eyebrow': '解釈',
    's10.h2': 'Cursor を独立した要因として評価すべきでない',
    's10.l.h3': '誤りやすい結論',
    's10.l.li0': '「X%速いのは Cursor のおかげ」',
    's10.l.li1': '「遅いのは Cursor が効いていないから」',
    's10.l.li2': 'ツール単体を測って一般化する',
    's10.r.h3': '適切な理解',
    's10.r.li0h':
      'Cursor は開発プロセスにおける<strong>支援ツール</strong>である',
    's10.r.li1': 'チケット結果は多要因の複合的な影響を受ける',
    's10.r.li2h':
    ...
    's11.eyebrow': '評価',
    's11.h2': '改善後の結果を評価する枠組み',
    's11.t1.tag': '01 Productivity',
    's11.t1.h3': '生産性',
    's11.t1.m': '月次の工数中央値',
    's11.t1.p': 'CxRy 別に追跡し、代表的工数が時間とともに下がっているかを見る。',
    's11.t2.tag': '02 Quality',
    's11.t2.h3': '品質',
    's11.t2.m': 'Bug density & Rework ratio',
    's11.t2.p':
      'スピードアップが品質低下や手戻り工数の増加を伴わないか確認する。',
    's11.t3.tag': '03 Stability',
    's11.t3.h3': '安定性',
    's11.t3.m': 'Variance',
    's11.t3.p': '工数の安定性と予測しやすさを時間軸で評価する。',
    's11.t4.tag': '04 Performance',
    's11.t4.h3': 'パフォーマンス',
    's11.t4.m': 'P75 & P90',
    's11.t4.p':
    ...
    's12.eyebrow': 'まとめ',
    's12.h2': '結論と組織的価値',
    's12.c1.h3': '新フレームワークが変えること',
    's12.c1.li0': '感覚的な CRE スコアから CxRy 分類へ',
    's12.c1.li1': 'Coding + バグ修正だけでなくエンドツーエンド工数を測定',
    's12.c1.li2': '正しい業務グループのベースラインとチケットを比較',
    's12.c1.li3': 'ベースラインでレビュー・警告・RCA に活用',
    's12.c2.h3': '組織レベルでの価値',
    's12.c2.li0': '業務グループごとの社内参照基準の形成',
    's12.c2.li1': '見積もりと計画を履歴データにより強く根拠づける',
    's12.c2.li2': '計画と工数レビューでの個人の感覚依存を減らす',
    's12.close':
